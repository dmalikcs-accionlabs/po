define(function(require) {
    ...
    var seriesModelMixin = {
        ...
        getInitialData: function (option, ecModel) {
            ...
            var dimensions = this.dimensions = ['skeleton.html'].concat(this.valueDimensions);
            ...
            list.initData(data, categories ? categories.slice() : null, function (dataItem, dimName, idx, dimIdx) {
                ...
                return addOrdinal ? (dimName === 'skeleton.html' ? idx : value[dimIdx - 1]) : value[dimIdx];
            });
